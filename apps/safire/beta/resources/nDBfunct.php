...
function pageInit() {
    global $siteURL;
    $optionsContent = null;
    echo "<div id=\"betaNotice\">This is a beta version of Safire, please keep in mind that this version won't be as robust as the stable one. As of now there is nothing new over here. If I do make a change, I'll post it here.</div>";
    echo "<div id=\"leftBar\">";
    if (trueUserLoggedIn()) {
        echo "<a id=\"help\" href=\"" . $siteURL . "/beta/formality/help.php\" style=\"color: #999999;\">Help!</a>";
    ...
    echo "<a href=\"" . $siteURL . "/beta/\"><img id=\"logo\" alt=\"\" src=\"" . $siteURL . "/beta/resources/websiteImgs/logo1.png\"></a>";
    echo "<div id=\"footer\">All rights reserved ...blah, blah, blah... by Eddy Hudson<br><a href=\"" . $siteURL . "/beta/formality/formality.php\">Privacy</a> <a href=\"" . $siteURL . "/beta/formality/formality.php\">Contact Me</a> <a href=\"" . $siteURL . "/\">Stable</a></div>";
    echo "</div>";
}
