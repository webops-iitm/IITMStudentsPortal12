...
function pageInit() {
    $optionsContent = null;
    echo "<div id=\"betaNotice\">This is a beta version of safire, please keep in mind that this version won't be as robust as the stable one. Certain visual elements have been added and bugs have been squashed. An entirely new feature called Notice Board has been added.</div>";
    echo "<div id=\"leftBar\">";
    if (isset($_SESSION['membInfo'])) {
        echo "<a id=\"help\" href=\"http://students2.iitm.ac.in/test/apps/safire/beta/formality/help.php\" style=\"color: #999999;\">Help!</a>";
    ...
    echo "<a href=\"http://students2.iitm.ac.in/test/apps/safire/beta/\"><img id=\"logo\" alt=\"\" src=\"http://students2.iitm.ac.in/test/apps/safire/beta/resources/websiteImgs/logo1.png\"></a>";
    echo "<div id=\"footer\">All rights reserved ...blah, blah, blah... by Eddy Hudson<br><a href=\"http://students2.iitm.ac.in/test/apps/safire/beta/formality/formality.php\">Privacy</a> <a href=\"http://students2.iitm.ac.in/test/apps/safire/beta/formality/formality.php\">Contact Me</a> <a href=\"http://students2.iitm.ac.in/test/apps/safire/\">Stable</a></div>";
    echo "</div>";
}
